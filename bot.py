...
if __name__ == "__main__":
    ...
    # 🔹 Tournament commands (यहीं डालने हैं)
    ...
    app.add_handler(CommandHandler("register_team", register_team))  # ✅ यहाँ add करना है
    app.add_handler(CommandHandler("join_team", join_team))          # ✅ यहाँ add करना है
